...
internal class Union(union: UnionElement): MutableJoinState {

    private sealed class Segment {

        class StatementsState(parent: StatementsSegment): Segment() {

            private val state = BasicGraphPattern(parent.statements)
    ...
    companion object {
        ...
        private fun dev.tesserakt.sparql.types.runtime.element.Segment.createIncrementalSegmentState() = when (this) {
