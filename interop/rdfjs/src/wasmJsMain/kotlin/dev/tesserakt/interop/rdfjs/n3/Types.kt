...
@JsName("Term")
external interface N3Term: JsAny {
    val termType: String
    val value: String
}
...
external class N3Store: JsAny {
    ...
    @JsName("addQuads")
    fun addAll(triples: JsArray<N3Quad>)
    ...
    fun getSubjects(): JsArray<N3Term>
    fun getPredicates(): JsArray<N3Term>
    fun getObjects(): JsArray<N3Term>
    fun getQuads(
        subject: N3Term = definedExternally,
        predicate: N3Term = definedExternally,
        `object`: N3Term = definedExternally,
